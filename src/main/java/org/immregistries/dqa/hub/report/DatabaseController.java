...
public class DatabaseController {
	...
	public CodeCollectionMap getCodesFor(@PathVariable("providerKey") String providerKey, @PathVariable("dateStart") @DateTimeFormat(pattern = "yyyyMMdd") Date dateStart, @PathVariable("dateEnd") @DateTimeFormat(pattern = "yyyyMMdd") Date dateEnd) {
    	logger.info("DatabaseController getCodesFor sender:" + providerKey + " dateStart: " + dateStart + " dateEnd: " + dateEnd);
	...
	public VaccinationCollectionMap getVaccinationsFor(@PathVariable("providerKey") String providerKey, @PathVariable("dateStart") @DateTimeFormat(pattern = "yyyyMMdd") Date dateStart, @PathVariable("dateEnd") @DateTimeFormat(pattern = "yyyyMMdd") Date dateEnd) {
		logger.info("DatabaseController getVaccinationsFor sender:" + providerKey + " dateStart: " + dateStart + " dateEnd: " + dateEnd);
		DqaMessageMetrics allDaysMetrics = metricsSvc.getMetricsFor(providerKey, dateStart, dateEnd);
