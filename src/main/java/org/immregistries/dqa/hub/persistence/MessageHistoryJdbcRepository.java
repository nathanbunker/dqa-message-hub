...
//			" AND mv.ack_status_id in (:status1, :status2) ";
	...
	public List<MessageCounts> getFacilityMessageHistoryAckStats(final String providerIdentifier, int year, Integer statId, String ackStatus1, String ackStatus2) {
		...
		try {
			fmcList.addAll(jdbcTemplate.query(getFacilityMessageHistoryAckStats,namedParameters, getHistoryRowMapper()));
		} catch (EmptyResultDataAccessException er) {
			LOGGER.warn("message history not found for interface id["
					+ providerIdentifier + "] and stat id[" + statId + "] ack1["+ ackStatus1 + "] ack2[" + ackStatus2 + "]");
		}
		return fmcList;
	}
	...
	@Cacheable("facilityHistory")
	public List<MessageCounts> getFacilityMessageHistoryAckStatsText(final String providerIdentifier, int year, String searchText, Integer statId, String ackStatus1, String ackStatus2) {
		//Convert ack status codes to IDs. 
		Integer ackSt1 = AckStatus.getIdForCode(ackStatus1);
		Integer ackSt2 = AckStatus.getIdForCode(ackStatus2);
		...
		try {
			fmcList.addAll(jdbcTemplate.query(getFacilityMessageHistoryAckStatsText,namedParameters, getHistoryRowMapper()));
		} catch (EmptyResultDataAccessException er) {
			LOGGER.warn("message history not found for interface id["
					+ providerIdentifier + "] and stat id[" + statId + "] ack1["+ ackStatus1 + "] ack2[" + ackStatus2 + "] srchText[" + searchText + "]");
		}
		return fmcList;
	}
	...
	@Cacheable("facilityHistory")
	public List<MessageCounts> getFacilityMessageHistoryStats(final String providerIdentifier, int year, Integer statId) {
		...
		try {
			fmcList.addAll(jdbcTemplate.query(getFacilityMessageHistoryStats,namedParameters, getHistoryRowMapper()));
		} catch (EmptyResultDataAccessException er) {
			LOGGER.warn("message history not found for interface id["
	...
	@Cacheable("facilityHistory")
	public List<MessageCounts> getFacilityMessageHistoryStatsAndMessageSearchText(final String providerIdentifier, int year, Integer statId, String searchText) {
		...
		try {
			fmcList.addAll(jdbcTemplate.query(getFacilityMessageHistoryStatsAndMessageSearchText,namedParameters, getHistoryRowMapper()));
		} catch (EmptyResultDataAccessException er) {
			LOGGER.warn("message history not found for interface id[" + providerIdentifier + "] and stat id[" + statId + "] searchTxt[" + searchText + "]");
		}
		return fmcList;
	}
	...
	@Cacheable("facilityHistory")
	public List<MessageCounts> getFacilityMessageHistorySearchText(final String providerIdentifier, int year, String searchText) {
		...
		try {
			fmcList.addAll(jdbcTemplate.query(getFacilityMessageHistorySearchText, namedParameters, getHistoryRowMapper()));
		} catch (EmptyResultDataAccessException er) {
			LOGGER.warn("message history not found for interface id[" + providerIdentifier + "] searchTxt[" + searchText + "]");
		}
	...
	@Cacheable("facilityHistory")
	public List<MessageCounts> getFacilityMessageHistoryAckStatusAndMessageSearchText(final String providerIdentifier, int year, String messageSearchString, String ackStatus1, String ackStatus2) {
	...
	@Cacheable("facilityHistory")
	public List<MessageCounts> getFacilityMessageHistoryAckStatus(final String providerIdentifier, int year, String ackStatus1, String ackStatus2) {
