...
public enum VaccineReportGroup {
                                ...
                                DTAP("DTaP", "28", "20", "106", "107", "146", "170", "110", "50",
                                    "120", "130", "132", "01", "22", "102"),
                                HEPA("Hep A", "83", "52", "84", "31", "85", "104"),
                                HEPB("Hep B", "146", "110", "132", "102", "189", "08", "42", "43",
                                    "44", "45", "58"),
                                HERPES("Herpes", "60"),
                                HIB("Hib", "146", "170", "50", "120", "132", "22", "102", "47",
                                    "46", "49", "48", "17", "51"),
                                HIV("HIV", "61"),
                                HPV("HPV", "118", "62", "137", "165"),
                                IMMUNEGLOBULIN("Immune Globulin", "86", "14", "87"),
                                INFLUENZA("Influenza", "160", "151", "123", "135", "153", "171",
                                    "186", "158", "150", "161", "166", "111", "149", "155", "185",
                                    "141", "140", "144", "15", "168", "88", "16"),
                                ...
                                MENING("Mening", "108", "163", "162", "164", "103", "148", "147",
                                    "136", "114", "32", "167"),
                                MMR("MMR", "04", "03", "94"),
                                MUMPS("Mumps", "07", "38"),
                                ...
                                PLAGUE("Plague", "23"),
                                POLIO("Polio", "146", "170", "110", "120", "130", "132", "10", "02",
                                    "179", "178", "182", "89"),
                                ...
                                STAPHYLOCOCCUSBACTERIOLYSATE("Staphylococcus Bacterio Lysate",
                                    "76"),
                                TDAP("Td/Tdap", "138", "09", "113", "139", "115"),
                                ...
                                VENEZUELANEQUINEENCEPHALITIS("Venezuelan Equine Encephalitis", "81",
                                    "80", "92"),
  ...
  static Map<String, List<VaccineReportGroup>> map = new HashMap<>();
  static {
  ...
  public static List<VaccineReportGroup> get(String cvx) {
    List<VaccineReportGroup> v = map.get(cvx);
    if (v == null) {
      v = new ArrayList<>();
      v.add(VaccineReportGroup.UNKNOWN);
    }
    return v;
  }
}
