...
public interface FacilityMessageCountsJpaRepository extends JpaRepository<FacilityMessageCounts, Long> {
  ...
  List<FacilityMessageCounts> findByUsernameEqualsAndFacilityNameAndUploadDateGreaterThanEqualAndUploadDateLessThanEqual(String username, String sender, Date beginDate, Date endDate);
}
