...
export class ReportingService {
  ...
  getExampeMessageByDetection(detection: string, provider: string, dateStart: string, dateEnd: string): Observable<IExampleMessage> {
    return this.http.get<IExampleMessage>(
  ...
  getExampeMessageByCode(
    ...
    provider: string,
    dateStart: string,
    dateEnd: string): Observable<IExampleMessage> {
    return this.http.get<IExampleMessage>(
